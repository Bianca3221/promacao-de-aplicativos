...
def cadastrar_aluno() :
    try:
        ...
        cidade_estado = input("Digite a cidade e estado do aluno: ")
        id_professor = input("Digite o ID do professor: ")


        comando_inserir = (f'''
            INSERT INTO alunos (nome,telefone,turma,idade,cpf,cidade_estado,id_professor)
            VALUES ('{nome_aluno}','{telefone_aluno}','{turma_aluno}',{idade_aluno},'{cpf_aluno}','{cidade_estado}','{id_professor}')''')
    ...
    try :
        ...
        if not todos_alunos: 
            ...
            for aluno in todos_alunos:
                print (f"ID: {aluno[0]}, nome: {aluno[1]}, Telefone: {aluno[2]}, turma: {aluno[3]}, idade: {aluno[4]}, CPF: {aluno[5]}, cidade_estado: {aluno[6]},id_professor: {aluno[7]}")
